---
layout: post
title: 'Optimizing Hadoop Ingests'
---
...
<img src="../assets/img/projects/optimizing-hadoop-ingests/loading.gif" width="100%">
...
Automatic retry drastically reduced the number of failed ingests per day. With the old process, it was common for up to 20 table ingestions to fail per week. With automatic retry, that number was reduced to near 0. 
